...
use App\Models\AppProjectNoChecked;
...
class AppProjectNoCheckedController extends Controller
{
    ...
    {
        $grid = new Grid(new AppProjectNoChecked);
    ...
    {
        $show = new Show(AppProjectNoChecked::findOrFail($id));
    ...
    {
        $form = new Form(new AppProjectNoChecked);
